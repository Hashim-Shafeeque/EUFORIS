...
def check_internet_status():
    ...
    try:
        ...
        if op == 200:
            ...
            speak_print = "successfully connected to network. internet connection is now available . System is now online and running"
...
def face_id_face_recognition():
    ...
    if id == name_1:
        ...
        speak_print = f"unknown face was detected. Facial is data is saved in case of any malicious activity and for security reasons."
        speak(f"unknown face was detected. Facial is data is saved in case of any malicious activity and for security reasons.")
        wish()
    else:
        pass
    ...
    def taskexecution(self):
        ...
        while True:
            ...
            if WAKE_WORD in self.text or "wake up" in self.text or "ഫ്രൈഡേ" in self.text:
                ...
                if "remember this" in self.text or "write this down" in self.text or "make a note" in self.text:
                ...
                elif "to malayalam" in self.text:
                    AudioPlayer("audio/listening_sound.mp3").play(block=True)
                    speak_language = 'ml'
                    ...
                    AudioPlayer("audio/listening_sound.mp3").play(block=True)
                    possible_reply = ["is there any problem ? .", "whats the matter?.", "how was that ? .", "is everything good ? .", "that was no big deal."]
                    reply = random.choice(possible_reply)
                    print(reply)
                    speak_print = reply
                    AudioPlayer("speech_engine.wav").play(block=True)
                    ...
                    AudioPlayer("audio/listening_sound.mp3").play(block=True)
                    possible_reply = ["done.", "that was no big deal.", "how's that? ."]
                    reply = random.choice(possible_reply)
                    print(reply)
                    AudioPlayer("speech_engine.wav").play(block=True)
                    ...
                    speak_print = "sure, aren't you coming?. wait, i think it's better if you stay here . because if you come, hell will be a lot more heller."
                    ...
                    speak_print = "oh. i feel sorry to hear that. and i also feel sorry because i wanted to be as dumb as you, but it seems that it's impossible to beat you in terms of dumbness"
                ...
                #    recognize_malayalam()
                    ...
                    speak_print = reply
                    speak(reply)
                    os.startfile("audio/barndoorprotocol.mp4")
                    # sleep(20)
                ...
                #    os.system("taskkill /f /im C:/Users/user/Documents")
                    ...
                    speak_print = "now opening  Spottify , let's chill"
